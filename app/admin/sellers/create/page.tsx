...
export default function CreateManualApplicationPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const applicationData = {
        ...
        monthlyTransactionVolume: Number.parseInt(formData.monthlyTransactionVolume) || 0,
  ...
  const headerActions = (
    <div className="flex gap-3">
      <Button variant="outline" onClick={() => router.push("/admin/sellers")} className="gap-2 bg-transparent">
